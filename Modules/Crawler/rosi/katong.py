...
#   日期：2016-02-15
#   语言：Python 2.7.10
#   说明：爬取http://www.5442.com/tag/dongman/网站动漫图
...
class GetRosiUrl(HttpClient):
    def __init__(self):
        self.__pageIndex = 1
        self.__Url = "http://www.5442.com/tag/dongman/"
        self.__refer = "http://www.5442.com/tag/dongman.html"
...
class DownloadImg(HttpClient):
    ...
    def start(self):
        while True:
            ...
            #创建与图片集名称相同的子目录
            self.__folder = os.getcwd() + "\\katong\\" + title.decode("gbk", 'ignore')
