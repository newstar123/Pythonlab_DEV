...
class GetRosiUrl(HttpClient):
    def __init__(self):
        self.__pageIndex = 1
        self.__Url = "http://www.5442.com/tag/xiezhen/"
        self.__refer = "http://www.5442.com/tag/xiezhen.html"
...
class DownloadImg(HttpClient):
    ...
    def start(self):
        while True:
            ...
            #创建与图片集名称相同的子目录
            self.__folder = os.getcwd() + "\\xiezhen\\" + title.decode("gbk", 'ignore')
